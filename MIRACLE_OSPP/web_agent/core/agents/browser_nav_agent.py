...
from web_agent.core.memory_user.static_ltm import get_user_ltm
from web_agent.core.prompts import LLM_PROMPTS
from web_agent.core.skills.click_using_selector import click as click_element

# from web_agent.core.skills.enter_text_and_click import enter_text_and_click
from web_agent.core.skills.enter_text_using_selector import bulk_enter_text
from web_agent.core.skills.enter_text_using_selector import entertext
from web_agent.core.skills.get_dom_with_content_type import get_dom_with_content_type
from web_agent.core.skills.get_url import geturl
from web_agent.core.skills.open_url import openurl
from web_agent.core.skills.pdf_text_extractor import extract_text_from_pdf

#from web_agent.core.skills.pdf_text_extractor import extract_text_from_pdf
from web_agent.core.skills.press_key_combination import press_key_combination
...
class BrowserNavAgent:
    ...
    def __get_ltm(self):
        """
        Get the the long term memory_user of the user.
