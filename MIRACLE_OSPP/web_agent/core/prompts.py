...
Some basic information about the user: $basic_user_information""",
   ...
   Ensure that user questions are answered from the DOM and not from memory_user or assumptions. To answer a question about textual information on the page, prefer to use text_only DOM type. To answer a question about interactive elements, use all_fields DOM type.
   ...
   "ADD_TO_MEMORY_PROMPT": """"Save any information that you may need later in this term memory_user. This could be useful for saving things to do, saving information for personalisation, or even saving information you may need in future for efficiency purposes E.g. Remember to call John at 5pm, This user likes Tesla company and considered buying shares, The user enrollment form is available in <url> etc.""",
   ...
   "GET_MEMORY_PROMPT": """Retrieve all the information previously stored in the memory_user""",
